...
=======
	@GetMapping(params= {"code"})
	public List<ReservationResponse> getAllReservationByUserEmail(@RequestParam String email) {
	...
	public List<FlightResponse> getAllFlightByReservationCode(@PathVariable String code) {
